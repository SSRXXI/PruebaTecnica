...
namespace MultiSF
{
    ...
    public class PersonaController : ControllerBase
    {
        ...
        public PersonaController(PRUEBASFContext context)
        {
            _context = context;
        }
        ...
        [Route("Full")]
        [HttpGet]
        public async Task<ActionResult<IEnumerable<PersonaFull>>> GetPersonasFull()
        {

            var personas = (from person in _context.Personas
                            select new PersonaFull
                            {
                                Id = person.Id,
        ...
        public async Task<ActionResult<Persona>> PostPersona(Persona persona)
        {
            ...
            return Content("Persona creada correctamente");
        }
